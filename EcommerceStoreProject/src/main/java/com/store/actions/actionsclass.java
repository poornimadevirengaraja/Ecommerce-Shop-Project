...
import com.store.actionsinterface.actionsinterface;
 ...
 * 
 * **/
public class actionsclass extends baseclass implements actionsinterface {
	...
	/*
	 * @Override public boolean switchToFrameByIndex(WebDriver driver,int index) {
